...
def main():
    ...
    networking_params = {
        ...
        "random_waypoint": {
            ...
            "arena_corner_1": {"x": -50.0, "y": -50.0, "z": 5.0},
            "arena_corner_2": {"x": 50.0, "y": 50.0, "z": 50.0},
        }
    }
    ...
    physics_package_node = "mini_dancers mini_dancers"
    
    launch_sim_components_in_tmux(configs_paths[0], network_package_node, physics_package_node, session_id=1, remain_on_exit=True, headless=False)
