...
def launch_sim_components_in_tmux(
    ...
    env_prefix = f"ROS_DOMAIN_ID={session_id} NS_LOG=WiFiAppWaypointBroadcast=level_debug"
...
def main():
    ...
    empty_connectors_params = {
        # "net_sleep_time": 1000000, # unused
        "phy_sleep_time": 10000,
    }
    ...
    networking_params = {
        ...
        "random_waypoint": {
            "new_waypoint_interval": 20000000,   # in us
            "arena_corner_1": {"x": -100.0, "y": -100.0, "z": 5.0},
            "arena_corner_2": {"x": 100.0, "y": 100.0, "z": 20.0},
        }
    }
    ...
    network_package_node = "ns3_connector basic_wifi_adhoc"           # Change if needed
    physics_package_node = "mini_dancers mini_dancers"           # Change if needed
    
    launch_sim_components_in_tmux(configs_paths[0], network_package_node, physics_package_node, session_id=1, remain_on_exit=True)
